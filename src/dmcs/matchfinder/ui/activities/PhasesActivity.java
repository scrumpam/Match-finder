...
public class PhasesActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		try {
	        ...
	        ListAdapter listViewAdapter = new SimpleAdapter(this, exampleItems, R.layout.list_item_phases,
...
//				String sell = ((TextView) view.findViewById(R.id.sell).getText().toString();
				...
				Intent in = new Intent(getApplicationContext(), MatchesActivity.class);
